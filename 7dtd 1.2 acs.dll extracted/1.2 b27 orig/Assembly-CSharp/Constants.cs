...
public class Constants
{
	...
	public const int cVersionMinor = 2;

	public const int cVersionBuild = 27;

	public static readonly VersionInformation cVersionInformation = new VersionInformation(VersionInformation.EGameReleaseType.V, 1, 2, 27);
